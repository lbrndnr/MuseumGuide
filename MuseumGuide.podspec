Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/larcus94/MuseumGuide"
  s.screenshot  = "https://raw.githubusercontent.com/larcus94/MuseumGuide/master/Screenshots/Example.png"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = { "Laurin Brandner" => "hello@laurinbrandner.ch" }
  s.social_media_url   = "http://twitter.com/larcus94"
  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/larcus94/MuseumGuide.git", :tag => s.version }
